      ...
      <div className="max-w-6xl mx-auto relative z-10" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="space-y-3 mb-8">
              {services.map((service) => (
                <div key={service} className="flex items-center gap-3 text-gray-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-white/5 border border-white/10 rounded-lg text-gray-200 hover:bg-white/10 transition-colors duration-300"
          ...
          <motion.div
            ...
            className="p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10"
          >
            <h3 className="text-2xl font-bold text-gray-100 mb-6">Freelance Snapshot</h3>
